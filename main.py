...
if __name__ == "__main__":
    ...
    if config.TOOLBOX_MODE == "train_and_test":
        ...
        elif config.TRAIN.DATA.DATASET == "CameraBP":
            train_loader = data_loader.CameraBPLoader.CameraBPLoader
        else:
            raise ValueError("Unsupported dataset! Currently supporting UBFC-rPPG, PURE, MMPD, \
                             SCAMPS, BP4D+ (Normal and BigSmall preprocessing), UBFC-PHYS, iBVP and CameraBP.")
        ...
        elif config.VALID.DATA.DATASET == "CameraBP":
            valid_loader = data_loader.CameraBPLoader.CameraBPLoader
    ...
    if config.TOOLBOX_MODE == "train_and_test" or config.TOOLBOX_MODE == "only_test":
        ...
        elif config.UNSUPERVISED.DATA.DATASET == "CameraBP":
            unsupervised_loader = data_loader.CameraBPLoader.CameraBPLoader
        else:
            raise ValueError("Unsupported dataset! Currently supporting UBFC-rPPG, PURE, MMPD, \
                             SCAMPS, BP4D+, UBFC-PHYS, iBVP and CameraBP.")
