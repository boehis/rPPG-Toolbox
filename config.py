...
_C.TRAIN.DATA.FILTERING.SELECT_INDICES = False
_C.TRAIN.DATA.FILTERING.INDEX_LIST = []
_C.TRAIN.DATA.FILTERING.SELECT_CAM = False
_C.TRAIN.DATA.FILTERING.CAM_LIST = []
_C.TRAIN.DATA.FILTERING.LOSO_CV = False
_C.TRAIN.DATA.FS = 0
...
_C.VALID.DATA.FILTERING.SELECT_INDICES = False
_C.VALID.DATA.FILTERING.INDEX_LIST = []
_C.VALID.DATA.FILTERING.SELECT_CAM = False
_C.VALID.DATA.FILTERING.CAM_LIST = []
_C.VALID.DATA.FILTERING.LOSO_CV = False
_C.VALID.DATA.FS = 0
...
_C.TEST.DATA.FILTERING.SELECT_INDICES = False
_C.TEST.DATA.FILTERING.INDEX_LIST = []
_C.TEST.DATA.FILTERING.SELECT_CAM = False
_C.TEST.DATA.FILTERING.CAM_LIST = []
_C.TEST.DATA.FILTERING.LOSO_CV = False
_C.TEST.DATA.FS = 0
...
_C.UNSUPERVISED.DATA.FILTERING.SELECT_INDICES = False
_C.UNSUPERVISED.DATA.FILTERING.INDEX_LIST = []
_C.UNSUPERVISED.DATA.FILTERING.SELECT_CAM = False
_C.UNSUPERVISED.DATA.FILTERING.CAM_LIST = []
_C.UNSUPERVISED.DATA.FILTERING.LOSO_CV = False
...
def update_config(config, args):
    ...
    if config.TOOLBOX_MODE in ['train_and_test', 'only_test', 'loso_cv']:
